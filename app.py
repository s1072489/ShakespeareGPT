...
if __name__ == "__main__":
    gr.Interface(fn=main, inputs=[gr.Textbox(label='Starting context'), gr.Number(label="Maximum output tokens")], outputs=[gr.Textbox(label="Response:")], title="ShakespeareGPT", article="More information is available on Github at s1072489/ShakespeareGPT!").launch()
